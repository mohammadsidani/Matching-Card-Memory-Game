...
var temp, c, len = emojis.length;
if(len) while(--len) {
   c = Math.floor(Math.random() * (len + 1));
   temp = emojis[c];
   emojis[c] = emojis[len];
   emojis[len] = temp;
}
